...
public class AutenticacaoFilter extends OncePerRequestFilter {
    ...
    public AutenticacaoFilter(CarregarUsuarioPorUsernameUseCase carregarUsuarioPorUsernameUseCase, 
                             ValidarTokenUseCase validarTokenUseCase, 
                             GerenciadorTokenJwt jwtTokenManager) {
        this.carregarUsuarioPorUsernameUseCase = carregarUsuarioPorUsernameUseCase;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (jwtToken != null) {
            try {
                username = validarTokenUseCase.extrairUsername(jwtToken);
    ...
    private void addUsernameInContext(HttpServletRequest request, HttpServletResponse response, String username, String jwtToken) {
        try {
            UserDetails userDetails = carregarUsuarioPorUsernameUseCase.executar(username);

            if (validarTokenUseCase.executar(jwtToken, userDetails)) {
