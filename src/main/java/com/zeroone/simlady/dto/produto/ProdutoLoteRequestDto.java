...
@Data
public class ProdutoLoteRequestDto {
    ...
    @Schema(description = "Nome do fornecedor/marca", example = "O Boticário")
    private String fornecedorNome;

    @Schema(description = "CNPJ do fornecedor (opcional)", example = "12.345.678/0001-90")
    private String fornecedorCnpj;

    @Schema(description = "Descrição do fornecedor (opcional)", example = "Fornecedor de perfumes e cosméticos")
    private String fornecedorDescricao;

    @Schema(description = "URL da imagem do fornecedor (opcional)", example = "https://boticario-logo.png")
    private String fornecedorImagemUrl;
}
